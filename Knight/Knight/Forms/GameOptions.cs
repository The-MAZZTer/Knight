...
namespace MZZT.Knight.Forms {
	public class GameOptions : Form {
		public GameOptions() : base() { }
		
		public GameOptions(Game game) : base() {
			this.Game = game;

			IntPtr handle = (this.Game.LargeIcon as Bitmap).GetHicon();
			try {
		...
		public GameSettings Settings => Program.Settings.GetGameSettings(this.Game.WhichGame);
