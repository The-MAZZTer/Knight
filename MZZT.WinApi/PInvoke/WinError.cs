namespace MZZT.WinApi.PInvoke {
	public static class WinError {
		public enum ERROR {
			...
			PEERDIST_CONTENTINFO_VERSION_UNSUPPORTED = 4050,
			PEERDIST_CANNOT_PARSE_CONTENTINFO = 4051,
			PEERDIST_MISSING_DATA = 4052,
			PEERDIST_NO_MORE = 4053,
			PEERDIST_NOT_INITIALIZED = 4054,
			PEERDIST_ALREADY_INITIALIZED = 4055,
			PEERDIST_SHUTDOWN_IN_PROGRESS = 4056,
			PEERDIST_INVALIDATED = 4057,
			PEERDIST_ALREADY_EXISTS = 4058,
			PEERDIST_OPERATION_NOTFOUND = 4059,
			PEERDIST_ALREADY_COMPLETED = 4060,
			PEERDIST_OUT_OF_BOUNDS = 4061,
			PEERDIST_VERSION_UNSUPPORTED = 4062,
			PEERDIST_INVALID_CONFIGURATION = 4063,
			PEERDIST_NOT_LICENSED = 4064,
			PEERDIST_SERVICE_UNAVAILABLE = 4065,
			PEERDIST_TRUST_FAILURE = 4066,
			...
			DNS_RESPONSE_CODES_BASE = 9000,
			DNS_MASK = 0x00002328,
			DNS_RCODE_FORMAT_ERROR = 9001,
			DNS_RCODE_SERVER_FAILURE = 9002,
			DNS_RCODE_NAME_ERROR = 9003,
			DNS_RCODE_NOT_IMPLEMENTED = 9004,
			DNS_RCODE_REFUSED = 9005,
			DNS_RCODE_YXDOMAIN = 9006,
			DNS_RCODE_YXRRSET = 9007,
			DNS_RCODE_NXRRSET = 9008,
			DNS_RCODE_NOTAUTH = 9009,
			DNS_RCODE_NOTZONE = 9010,
			DNS_RCODE_BADSIG = 9016,
			DNS_RCODE_BADKEY = 9017,
			DNS_RCODE_BADTIME = 9018,
			DNS_RCODE_LAST = DNS_RCODE_BADTIME,
			DNS_DNSSEC_BASE = 9100,
			...
			DNS_PACKET_FMT_BASE = 9500,
			DNS_INFO_NO_RECORDS = 9501,
			DNS_BAD_PACKET = 9502,
			DNS_NO_PACKET = 9503,
			DNS_RCODE = 9504,
			DNS_UNSECURE_PACKET = 9505,
			DNS_STATUS_PACKET_UNSECURE = DNS_UNSECURE_PACKET,
			DNS_REQUEST_PENDING = 9506,
			DNS_NO_MEMORY = OUTOFMEMORY,
			DNS_INVALID_NAME = INVALID_NAME,
			DNS_INVALID_DATA = INVALID_DATA,
			DNS_GENERAL_API_BASE = 9550,
			...
			DNS_RRL_NOT_ENABLED = 9911,
			DNS_RRL_INVALID_WINDOW_SIZE = 9912,
			DNS_RRL_INVALID_IPV4_PREFIX = 9913,
			DNS_RRL_INVALID_IPV6_PREFIX = 9914,
			DNS_RRL_INVALID_TC_RATE = 9915,
			DNS_RRL_INVALID_LEAK_RATE = 9916,
			DNS_RRL_LEAK_RATE_LESSTHAN_TC_RATE = 9917,
			DNS_VIRTUALIZATION_INSTANCE_ALREADY_EXISTS = 9921,
			DNS_VIRTUALIZATION_INSTANCE_DOES_NOT_EXIST = 9922,
			DNS_VIRTUALIZATION_TREE_LOCKED = 9923,
			DNS_INVAILD_VIRTUALIZATION_INSTANCE_NAME = 9924,
			DNS_DEFAULT_VIRTUALIZATION_INSTANCE = 9925,
			DNS_ZONESCOPE_ALREADY_EXISTS = 9951,
			DNS_ZONESCOPE_DOES_NOT_EXIST = 9952,
			DNS_DEFAULT_ZONESCOPE = 9953,
			DNS_INVALID_ZONESCOPE_NAME = 9954,
			DNS_NOT_ALLOWED_WITH_ZONESCOPES = 9955,
			DNS_LOAD_ZONESCOPE_FAILED = 9956,
			DNS_ZONESCOPE_FILE_WRITEBACK_FAILED = 9957,
			DNS_INVALID_SCOPE_NAME = 9958,
			DNS_SCOPE_DOES_NOT_EXIST = 9959,
			DNS_DEFAULT_SCOPE = 9960,
			DNS_INVALID_SCOPE_OPERATION = 9961,
			DNS_SCOPE_LOCKED = 9962,
			DNS_SCOPE_ALREADY_EXISTS = 9963,
			DNS_POLICY_ALREADY_EXISTS = 9971,
			DNS_POLICY_DOES_NOT_EXIST = 9972,
			DNS_POLICY_INVALID_CRITERIA = 9973,
			DNS_POLICY_INVALID_SETTINGS = 9974,
			DNS_CLIENT_SUBNET_IS_ACCESSED = 9975,
			DNS_CLIENT_SUBNET_DOES_NOT_EXIST = 9976,
			DNS_CLIENT_SUBNET_ALREADY_EXISTS = 9977,
			DNS_SUBNET_DOES_NOT_EXIST = 9978,
			DNS_SUBNET_ALREADY_EXISTS = 9979,
			DNS_POLICY_LOCKED = 9980,
			DNS_POLICY_INVALID_WEIGHT = 9981,
			DNS_POLICY_INVALID_NAME = 9982,
			DNS_POLICY_MISSING_CRITERIA = 9983,
			DNS_INVALID_CLIENT_SUBNET_NAME = 9984,
			DNS_POLICY_PROCESSING_ORDER_INVALID = 9985,
			DNS_POLICY_SCOPE_MISSING = 9986,
			DNS_POLICY_SCOPE_NOT_ALLOWED = 9987,
			DNS_SERVERSCOPE_IS_REFERENCED = 9988,
			DNS_ZONESCOPE_IS_REFERENCED = 9989,
			DNS_POLICY_INVALID_CRITERIA_CLIENT_SUBNET = 9990,
			DNS_POLICY_INVALID_CRITERIA_TRANSPORT_PROTOCOL = 9991,
			DNS_POLICY_INVALID_CRITERIA_NETWORK_PROTOCOL = 9992,
			DNS_POLICY_INVALID_CRITERIA_INTERFACE = 9993,
			DNS_POLICY_INVALID_CRITERIA_FQDN = 9994,
			DNS_POLICY_INVALID_CRITERIA_QUERY_TYPE = 9995,
			DNS_POLICY_INVALID_CRITERIA_TIME_OF_DAY = 9996,
			WSAEINTR = 10004,
			WSAEBADF = 10009,
			WSAEACCES = 10013,
			WSAEFAULT = 10014,
			...
			APPMODEL_NO_PACKAGE = 15700,
			APPMODEL_PACKAGE_RUNTIME_CORRUPT = 15701,
			APPMODEL_PACKAGE_IDENTITY_CORRUPT = 15702,
			APPMODEL_NO_APPLICATION = 15703,
			APPMODEL_DYNAMIC_PROPERTY_READ_FAILED = 15704,
			APPMODEL_DYNAMIC_PROPERTY_INVALID = 15705,
			APPMODEL_PACKAGE_NOT_AVAILABLE = 15706,
			...
			STORE_UNLICENSED = 15861,
			STORE_UNLICENSED_USER = 15862,
			STORE_PENDING_COM_TRANSACTION = 15863,
			STORE_LICENSE_REVOKED = 15864
		}
	}
}
